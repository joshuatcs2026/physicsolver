...
const tests = [
  ...
  ['phase 3 general solver', ['tests/unit/general-solver.test.js']],
  ['phase 3 catalog integration', ['tests/unit/catalog-solver.test.js']],
  ['phase 3 application integration', ['tests/unit/phase3-integration.test.js']],
